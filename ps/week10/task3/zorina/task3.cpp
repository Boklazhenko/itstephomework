...
//Реализуйте для него следующие возможности : Редактировать книгу Печать всех книг 
//Поиск книг по автору Поиск книги по названию Сортировка массива по названию книг Сортировка массива по автору
...
void sortLibByName(Book library[], int size) //пыталась разобраться с библиотечной функцией qsort_s сортировки строк, но ее аргументы повергли в 
{                                           // ступор, если будет время на паре расскажи, пожалуйста, что такое compare, я так и не поняла,
	Book tempBook;                          //в этот раз и племянник не помог, мы его обогнали( 
	for (int i = 0; i < size - 1; i++) {    //Идею этой сортировки взяла у Сережи, чуток исправила
