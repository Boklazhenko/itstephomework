...
void unsetOptions(Client& client, uint8_t options) {    //надо учитывать что она может активировать ранее не активные опции
    client.Options ^= options;                          //если попытаться их отключить
}
